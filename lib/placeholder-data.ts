...
export const facilities: Facility[] = [
  {
    ...
    image: "/images/court-interior.jpg",
    details: [
      "FIP-certified international standard padel flooring",
      "Professional LED lighting at 1000+ lux for night play",
      "Shatter-resistant tempered glass surrounding the court",
      "Optimal air ventilation system for playing comfort",
      "6 indoor courts & 2 outdoor courts available",
    ],
  },
  {
    icon: "sofa",
    ...
    details: [
      "Exclusive lounge area with a direct view of the courts",
      "Premium sofas and private tables for VIP members",
      "Complimentary welcome drink on every visit",
      "Large-screen TV for watching live matches",
      "Ultra-fast Wi-Fi throughout the lounge area",
    ],
  },
  {
    icon: "lock",
    ...
    details: [
      "Spacious private lockers with digital keypad locks",
      "Separate men's & women's changing rooms",
      "Shower rooms with 24-hour hot water",
      "Full amenities provided (soap, shampoo, towels)",
      "Dedicated storage space for rackets and equipment",
    ],
  },
  {
    icon: "car",
    ...
    details: [
      "Free valet service for all active members",
      "Parking area with capacity for 100+ vehicles",
      "24-hour CCTV surveillance throughout the parking area",
      "Dedicated disabled parking spaces available",
      "Electric vehicle (EV) charging stations on-site",
    ],
  },
  {
    icon: "dumbbell",
    ...
    details: [
      "200 m² warm-up area with full equipment",
      "International-brand cardio and weight machines",
      "Yoga mats and dedicated stretching corner",
      "Certified personal trainer available on request",
      "Tailored training programs for padel players",
    ],
  },
  {
    icon: "coffee",
    ...
    details: [
      "Full collection of rackets from top global brands",
      "Exclusive padel apparel and accessories",
      "On-site racket restringing & repair service",
      "Artisan cafe with healthy menu and energy drinks",
      "15% member discount on all pro shop purchases",
    ],
  },
];
